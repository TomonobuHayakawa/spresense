 ...
 */
#define MEMMGR_MAX_WORK_SIZE  0x00000094
...
#define MIC_IN_BUF_POOL	6
#define I2S_IN_BUF_POOL	7
#define HP_OUT_BUF_POOL	8
#define I2S_OUT_BUF_POOL	9
#define MFE_OUT_BUF_POOL	10

#define NUM_MEM_LAYOUTS	2
#define NUM_MEM_POOLS	11
 ...
 */
/* Layout0: */
#define MEMMGR_L0_WORK_SIZE   0x00000094
...
#define L0_DEC_APU_CMD_POOL_SIZE     0x000001cc
#define L0_DEC_APU_CMD_POOL_U_FENCE  0x000ea1ec
#define L0_DEC_APU_CMD_POOL_NUM_SEG  0x00000005
#define L0_DEC_APU_CMD_POOL_SEG_SIZE 0x0000005c

/* Skip 0x0004 bytes for alignment. */
#define L0_DEC_ES_SUB_BUF_POOL_ALIGN    0x00000008
#define L0_DEC_ES_SUB_BUF_POOL_L_FENCE  0x000ea1f4
#define L0_DEC_ES_SUB_BUF_POOL_ADDR     0x000ea1f8
#define L0_DEC_ES_SUB_BUF_POOL_SIZE     0x00002400
#define L0_DEC_ES_SUB_BUF_POOL_U_FENCE  0x000ec5f8
#define L0_DEC_ES_SUB_BUF_POOL_NUM_SEG  0x00000003
#define L0_DEC_ES_SUB_BUF_POOL_SEG_SIZE 0x00000c00

/* Remainder AUDIO_WORK_AREA=0x0000fa04 */

/* Layout1: */
#define MEMMGR_L1_WORK_SIZE   0x00000090

/* Skip 0x0004 bytes for alignment. */
#define L1_MIC_IN_BUF_POOL_ALIGN    0x00000008
#define L1_MIC_IN_BUF_POOL_L_FENCE  0x000c0004
#define L1_MIC_IN_BUF_POOL_ADDR     0x000c0008
#define L1_MIC_IN_BUF_POOL_SIZE     0x00000960
#define L1_MIC_IN_BUF_POOL_U_FENCE  0x000c0968
#define L1_MIC_IN_BUF_POOL_NUM_SEG  0x00000005
#define L1_MIC_IN_BUF_POOL_SEG_SIZE 0x000001e0

#define L1_I2S_IN_BUF_POOL_ALIGN    0x00000008
#define L1_I2S_IN_BUF_POOL_L_FENCE  0x000c096c
#define L1_I2S_IN_BUF_POOL_ADDR     0x000c0970
#define L1_I2S_IN_BUF_POOL_SIZE     0x000012c0
#define L1_I2S_IN_BUF_POOL_U_FENCE  0x000c1c30
#define L1_I2S_IN_BUF_POOL_NUM_SEG  0x00000005
#define L1_I2S_IN_BUF_POOL_SEG_SIZE 0x000003c0

#define L1_HP_OUT_BUF_POOL_ALIGN    0x00000008
#define L1_HP_OUT_BUF_POOL_L_FENCE  0x000c1c34
#define L1_HP_OUT_BUF_POOL_ADDR     0x000c1c38
#define L1_HP_OUT_BUF_POOL_SIZE     0x000012c0
#define L1_HP_OUT_BUF_POOL_U_FENCE  0x000c2ef8
#define L1_HP_OUT_BUF_POOL_NUM_SEG  0x00000005
#define L1_HP_OUT_BUF_POOL_SEG_SIZE 0x000003c0

#define L1_I2S_OUT_BUF_POOL_ALIGN    0x00000008
#define L1_I2S_OUT_BUF_POOL_L_FENCE  0x000c2efc
#define L1_I2S_OUT_BUF_POOL_ADDR     0x000c2f00
#define L1_I2S_OUT_BUF_POOL_SIZE     0x000012c0
#define L1_I2S_OUT_BUF_POOL_U_FENCE  0x000c41c0
#define L1_I2S_OUT_BUF_POOL_NUM_SEG  0x00000005
#define L1_I2S_OUT_BUF_POOL_SEG_SIZE 0x000003c0

#define L1_MFE_OUT_BUF_POOL_ALIGN    0x00000008
#define L1_MFE_OUT_BUF_POOL_L_FENCE  0x000c41c4
#define L1_MFE_OUT_BUF_POOL_ADDR     0x000c41c8
#define L1_MFE_OUT_BUF_POOL_SIZE     0x00000500
#define L1_MFE_OUT_BUF_POOL_U_FENCE  0x000c46c8
#define L1_MFE_OUT_BUF_POOL_NUM_SEG  0x00000008
#define L1_MFE_OUT_BUF_POOL_SEG_SIZE 0x000000a0
