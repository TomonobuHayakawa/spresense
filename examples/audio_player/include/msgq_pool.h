...
extern const MsgQueDef MsgqPoolDefs[NUM_MSGQ_POOLS] = {
  ...
  { 0xfe374, 88, 4, 0xffffffff, 0, 0 }, /* MSGQ_AUD_MGR */
  ...
  { 0xfe740, 48, 5, 0xffffffff, 0, 0 }, /* MSGQ_AUD_SUB_PLY */
  ...
  { 0xfec30, 32, 16, 0xffffffff, 0, 0 }, /* MSGQ_AUD_RND_SUB */
  { 0xfee30, 16, 8, 0xffffffff, 0, 0 }, /* MSGQ_AUD_RND_SUB_SYNC */
};
