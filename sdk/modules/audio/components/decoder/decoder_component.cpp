/********************************************************************
 *
 *  File Name: decoder_cmpt.cpp
 *
 *  Description: Decoder Componet
 *
...
#if 0
/*--------------------------------------------------------------------*/
void cbRcvDspErr(DspDrvErrPrm_t *p_param)
{
...
/*--------------------------------------------------------------------*/
void cbRcvDspUnloadCmplt(DspDrvUnloadCmpltPrm_t *p_param)
{
  Chateau_SignalSemaphore(sem_dec_cmp);
}
#endif
