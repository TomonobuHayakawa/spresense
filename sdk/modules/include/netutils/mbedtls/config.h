...
/**
 * @defgroup mbedtlsconfigstr configration
 * Configration data
 * @{
 */
...
/* SSL options */
#ifdef CONFIG_NETUTILS_MBEDTLS_SSL_MAX_CONTENT_LEN
#define MBEDTLS_SSL_MAX_CONTENT_LEN         CONFIG_NETUTILS_MBEDTLS_SSL_MAX_CONTENT_LEN /**< Maxium fragment length in bytes, determines the size of each of the two internal I/O buffers */
#endif
