#######################################################################
#
#      File Name: msgq_layout.rb
#
#      Description: Create message queue layout header and source
#
...
def make_msgq_pool_header(pools)
	title = File.basename(MsgqPoolFile) + " -- Message queue pool layout definition."
...
def make_msgq_id_header(macros, end_addr)
	title = File.basename(MsgqIdFile) + " -- Message queue pool ID and macro definition."
