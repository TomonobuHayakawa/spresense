...
#define NFC_HAL_QUICK_TIMER_ID (TIMER_3)
#define NFC_HAL_QUICK_TIMER_EVT_MASK    (TIMER_3_EVT_MASK)
...
#if defined(GKI_DEBUG) && (GKI_DEBUG == TRUE)
/* GKI Trace Macros */
#define GKI_TRACE_0(m)                          GKI_TRACE(m)
#define GKI_TRACE_1(m,p1)                       GKI_TRACE(m,p1)
#define GKI_TRACE_2(m,p1,p2)                    GKI_TRACE(m,p1,p2)
#define GKI_TRACE_3(m,p1,p2,p3)                 GKI_TRACE(m,p1,p2,p3)
#define GKI_TRACE_4(m,p1,p2,p3,p4)              GKI_TRACE(m,p1,p2,p3,p4)
#define GKI_TRACE_5(m,p1,p2,p3,p4,p5)           GKI_TRACE(m,p1,p2,p3,p4,p5)
#define GKI_TRACE_6(m,p1,p2,p3,p4,p5,p6)        GKI_TRACE(m,p1,p2,p3,p4,p5,p6)
#else
#define GKI_TRACE_0(m)
#define GKI_TRACE_1(m,p1)
#define GKI_TRACE_2(m,p1,p2)
...
#define GKI_TRACE_ERROR_0(m)                    GKI_TRACE(m)
#define GKI_TRACE_ERROR_1(m,p1)                 GKI_TRACE(m,p1)
#define GKI_TRACE_ERROR_2(m,p1,p2)              GKI_TRACE(m,p1,p2)
#define GKI_TRACE_ERROR_3(m,p1,p2,p3)           GKI_TRACE(m,p1,p2,p3)
#define GKI_TRACE_ERROR_4(m,p1,p2,p3,p4)        GKI_TRACE(m,p1,p2,p3,p4)
#define GKI_TRACE_ERROR_5(m,p1,p2,p3,p4,p5)     GKI_TRACE(m,p1,p2,p3,p4,p5)
#define GKI_TRACE_ERROR_6(m,p1,p2,p3,p4,p5,p6)  GKI_TRACE(m,p1,p2,p3,p4,p5,p6)
