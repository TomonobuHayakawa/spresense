...
#ifdef BUILDCFG
#include "buildcfg_gkie.h"
#endif

#include "gkie_target.h"

#if (defined(GKIE_LIB_BUILD) && (GKIE_LIB_BUILD == TRUE))
#else
#include "bt_types.h"
#endif
...
GKI_API extern void    GKI_delete_pools ();
#if GKI_BUFFER_DEBUG
GKI_API extern void GKI_dump_buffer_pools(void);
...
/* To get and release buffers, change owner and get size
 */
#define GKIH_freebuf      GKI_freebuf
#define GKIH_getbuf_debug GKI_getbuf_debug
#define GKIH_getbuf       GKI_getbuf
#define GKIH_getpoolbuf   GKI_getpoolbuf
#define GKIH_get_buf_size GKI_get_buf_size

/* User buffer queue management
 */
#define GKIH_dequeue           GKI_dequeue
#define GKIH_enqueue	       GKI_enqueue
#define GKIH_init_q	       GKI_init_q

/* Timer management
*/
#define GKIH_add_to_timer_list       GKI_add_to_timer_list
#define GKIH_delay	             GKI_delay
#define GKIH_remove_from_timer_list  GKI_remove_from_timer_list
#define GKIH_start_timer	     GKI_start_timer
#define GKIH_stop_timer		     GKI_stop_timer
#define GKIH_update_timer_list	     GKI_update_timer_list
#define GKIH_wait                    GKI_wait

/* To send buffers and events between tasks
 */
#define GKIH_read_mbox	 GKI_read_mbox	 
#define GKIH_send_msg	 GKI_send_msg	 
#define GKIH_send_event  GKI_send_event  

/* Task management
*/
#define GKIH_create_task      GKI_create_task     
#define GKIH_exit_task	      GKI_exit_task	     
#define GKIH_get_taskid	      GKI_get_taskid	     
GKI_API extern void    GKI_init(void);
GKI_API extern void    GKIH_shutdown(void);
GKI_API extern void    GKIH_run(void *);

/* Allocate (Free) memory from an OS
*/
#define GKIH_os_malloc GKI_os_malloc
#define GKIH_os_free   GKI_os_free

/* Disable Interrupts, Enable Interrupts
*/
#define GKIH_enable      GKI_enable
#define GKIH_disable	 GKI_disable
