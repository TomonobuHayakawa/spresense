...
#define NCI_MT_HALMSG       6   /* (NCI_MT_CFG << NCI_MT_SHIFT) = 0xC0 */ /*add for HALMsg pipe*/

#define NCI_MTS_CMD         0x20
#define NCI_MTS_RSP         0x40
#define NCI_MTS_NTF         0x60
#define NCI_MTS_CFG         0x80
#define NCI_MTS_HALMSG      0xC0 /*add for HALMsg pipe */
...
#define NCI_PARAM_ID_LF_ADV_FEAT        0x55    /* add NCI 1.0 */
