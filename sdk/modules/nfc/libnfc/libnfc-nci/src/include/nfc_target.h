...
#if (defined (EGKI_NCI_ENABLED) && (EGKI_NCI_ENABLED == TRUE))
...
/* Define to TRUE if compling for NFC Reader/Writer plus CE Only mode */
#ifndef NFC_RW_ONLY_PLUS_CE
#define NFC_RW_ONLY_PLUS_CE    FALSE
#endif
...
/* Define to TRUE to include the nfa_nv_co_read/write related functionalities */
#ifndef NFA_NV_CO_INCLUDED
#define NFA_NV_CO_INCLUDED          TRUE
#endif
...
/* CXD224X workaround: MIU device limitation, and more effient RF utilization */
#define LLCP_MIU                    ((size_t )248)  /* 254(Payload Max) - 3(NFC-DEP header) - 3(LLCP header) */
#endif
...
/* Timeout for polling UIM managemet gate status change(normal opation) */
#ifndef NFA_HCI_UIM_POLLING_NORMAL_TIMEOUT
#define NFA_HCI_UIM_POLLING_NORMAL_TIMEOUT    1000
#endif

/* Timeout for polling UIM managemet gate status change(abnormal: INTF_ERROR) */
/* UICC is probably not present, early teminate */
#ifndef NFA_HCI_UIM_POLLING_ABNORMAL_TIMEOUT
#define NFA_HCI_UIM_POLLING_ABNORMAL_TIMEOUT    100
#endif
...
#ifndef NFA_CE_INCLUDED
#define NFA_CE_INCLUDED            TRUE
#endif
