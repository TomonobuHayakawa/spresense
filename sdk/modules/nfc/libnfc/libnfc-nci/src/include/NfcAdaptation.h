...
/*******************************************************************************
** tNFC_ADAPTATION_CBACK Definitions
*******************************************************************************/
typedef void (tNFC_ADAPTATION_DM_CBACK) (UINT8 evnet, unsigned int status);
typedef void (tNFC_ADAPTATION_DEVINFO_CBACK) (UINT8 evnet, UINT16 data_len, UINT8 *p_data);
...
public:
    ...
    void    DownloadFirmwareGetDeviceInfo (tNFC_ADAPTATION_DM_CBACK*      p_dm_cback,
...
private:
    ...
    static tNFC_ADAPTATION_DM_CBACK* mDmCallback;           /* DeviceManagemnet cb */
    static tNFC_ADAPTATION_DEVINFO_CBACK* mDevInfoCallback; /* DeviceInfo report cb */
