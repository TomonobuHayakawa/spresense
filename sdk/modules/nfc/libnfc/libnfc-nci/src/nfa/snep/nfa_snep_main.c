...
#else
#include <stdlib.h>
tNFA_SNEP_CB *nfa_snep_cb_ptr=NULL;
#endif
...
#include <assert.h>
    nfa_snep_cb_ptr = (tNFA_SNEP_CB *)GKI_os_malloc( sizeof(tNFA_SNEP_CB) );
    assert (nfa_snep_cb_ptr);
#endif
...
/*******************************************************************************
**
** Function         nfa_snep_destroy
**
** Description      Destroy NFA SNEP
**
**
** Returns          None
**
...
#if NFA_DYNAMIC_MEMORY == TRUE
    if (nfa_snep_cb_ptr)
        GKI_os_free (nfa_snep_cb_ptr);
    nfa_snep_cb_ptr = NULL;
#endif
    nfa_snep_default_destroy ();
}
