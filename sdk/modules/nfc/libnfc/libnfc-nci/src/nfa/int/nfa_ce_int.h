...
#define NFA_CE_LISTEN_INFO_FELICA_HCEF      0x00001000  /* This is a listen_info for non-NDEF HCEF has high priority        *//* tempworkaround: HCEF has priority to T3T UICC*/
...
#else
extern tNFA_CE_CB *nfa_ce_cb_ptr;
#define nfa_ce_cb (*nfa_ce_cb_ptr)
#endif
