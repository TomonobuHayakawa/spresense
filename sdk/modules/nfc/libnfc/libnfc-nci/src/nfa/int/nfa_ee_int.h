...
/* data type for NFA_EE_API_LMRT_STATUS_EVT */
typedef  BT_HDR tNFA_EE_API_LMRT_STATUS; /* add for NFA_EeGetLmrtStatus */
...
typedef union
{
    ...
    tNFA_EE_API_LMRT_STATUS     lmrt_status; /* add for NFA_EeGetLmrtStatus */
} tNFA_EE_MSG;
...
**  Extra definition
*****************************************************************************/
#define NFA_EE_API_DISCONNECT_FLAGS_MASK   (0xff00)
#define NFA_EE_API_DISCONNECT_FLAGS_CONNID (0x8000)
#define NFA_EE_CONN_ID_MAX 0xf
...
void nfa_ee_api_lmrt_status(tNFA_EE_MSG *p_data); /* add for NFA_EeGetLmrtStatus */
