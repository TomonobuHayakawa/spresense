...
typedef struct
{
    ...
    tNFA_SYS_PROC_HCI_NV_WRITE_EVENT *p_proc_hci_nv_write_event_cback; /* CXD224x workaround: notify hci_nv_write */
    tNFA_SYS_PROC_HCI_ACT_FAIL_EVENT *p_proc_hci_act_fail_event_cback; /* CXD224x workaround: notify hci_act_fail */
} tNFA_SYS_CB;
...
tNFA_STATUS nfa_sys_send_snooze_cmd (UINT8 param); /* CXD224x workaround: Low Power control */
