...
BOOLEAN nfa_p2p_deactivate_llcp (void); /* workaround: accept NFA_DisablePolling() during RFST_DISCOVERY */
...
#define nfa_p2p_deactivate_llcp() (TRUE)
#define nfa_p2p_set_config(a)
#define nfa_p2p_update_listen_tech(a)
