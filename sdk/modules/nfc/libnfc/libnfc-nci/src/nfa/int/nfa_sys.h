...
typedef void (tNFA_SYS_PROC_HCI_NV_WRITE_EVENT) (void); /* CXD224x workaround: notify hci_nv_write */
typedef void (tNFA_SYS_PROC_HCI_ACT_FAIL_EVENT) (void); /* CXD224x workaround: notify hci_act_fail */
...
NFC_API extern void nfa_sys_destroy (void);
...
extern void nfa_sys_cback_reg_hci_nv_write_event (tNFA_SYS_PROC_HCI_NV_WRITE_EVENT *p_cback);
extern void nfa_sys_cback_notify_hci_nv_write_event ();
/* CXD224x workaround: notify hci_nv_write to jni end */

/* CXD224x workaround: notify hci_act_fail to jni start */
extern void nfa_sys_cback_reg_hci_act_fail_event (tNFA_SYS_PROC_HCI_ACT_FAIL_EVENT *p_cback);
extern void nfa_sys_cback_notify_hci_act_fail_event ();
