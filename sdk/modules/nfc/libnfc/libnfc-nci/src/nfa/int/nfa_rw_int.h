...
/* DTA workaround: add extra API and param  */
/* NFA_RW_OP_T3T_POLL params */
typedef struct
{
    UINT16              system_code;
    tT3T_POLL_RC        rc;
    UINT8               tsn;
} tNFA_RW_OP_PARAMS_T3T_POLL;
...
typedef union
{
    ...
    tNFA_RW_OP_PARAMS_T3T_POLL          t3t_poll;
...
#else
extern tNFA_RW_CB *nfa_rw_cb_ptr;
#define nfa_rw_cb (*nfa_rw_cb_ptr)
#endif
...
extern void    nfa_rw_destroy (void); /*add for: NFA_DYNAMIC_MEMORY == TRUE */
