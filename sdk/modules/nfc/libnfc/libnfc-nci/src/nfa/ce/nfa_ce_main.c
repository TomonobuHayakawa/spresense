...
#include <assert.h>
    nfa_ce_cb_ptr = (tNFA_CE_CB *)GKI_os_malloc( sizeof(tNFA_CE_CB) );
    assert (nfa_ce_cb_ptr);
#endif
...
/*******************************************************************************
**
** Function         nfa_ce_destroy
**
** Description      Destroy NFA CE
**
** Returns          None
**
*******************************************************************************/
