...
#else
#include <stdlib.h>
tNFA_CHO_CB *nfa_cho_cb_ptr=NULL;
#endif
...
#include <assert.h>
    nfa_cho_cb_ptr = (tNFA_CHO_CB *)GKI_os_malloc( sizeof(tNFA_CHO_CB) );
    assert (nfa_cho_cb_ptr);
#endif
...
/*******************************************************************************
**
** Function         nfa_cho_destroy
**
** Description      Destroy NFA Connection Handover
**
**
** Returns          None
**
