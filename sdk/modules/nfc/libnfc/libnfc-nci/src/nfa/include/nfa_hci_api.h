...
#define NFA_HCI_DISCONNECT_EVT                  0x80    /* Disconnected, add for NFA_HCIDISCONNECT_INCLUDED */
#define NFA_HCI_DELETEGATEANDPIPE_EVT           0x81    /* Delete all gates and pipes, add for NFA_HCIDISCONNECT_INCLUDED */
...
#define NFA_MAX_HCI_EVENT_LEN                   280     /* Max HCI event length   2014.10.14 modify 260->280 */
...
/* Data for NFA_HCI_DISCONNECT_EVT, add for NFA_HCIDISCONNECT_INCLUDED*/
typedef struct
{
    tNFA_STATUS         status;                         /* Status of deregistration */
} tNFA_HCI_DISCONNECT;

/* Data for NFA_HCI_DELETEGATEANDPIPE_EVT, add for NFA_HCIDISCONNECT_INCLUDED */
typedef struct
{
    tNFA_STATUS         status;                         /* Status of deleteallgataandpipe */
} tNFA_HCI_DELETEGATEANDPIPE;
...
typedef union
{
    ...
    tNFA_HCI_DISCONNECT             hci_disconnect; /* NFA_HCI_DISCONNECT_EVT, add for NFA_HCIDISCONNECT_INCLUDED */
    tNFA_HCI_DELETEGATEANDPIPE      hci_deletegateandpipe; /* NFA_HCI_DELETEGATEANDPIPE_EVT, add for NFA_HCIDISCONNECT_INCLUDE   */
} tNFA_HCI_EVT_DATA;
...
/* add for NFA_HCIDISCONNECT_INCLUDED */
/*******************************************************************************
**
...
**
*******************************************************************************/
NFC_API extern tNFA_STATUS NFA_HciDeleteGateAndPipe (char *p_app_name);
#ifdef __cplusplus
}
#endif
