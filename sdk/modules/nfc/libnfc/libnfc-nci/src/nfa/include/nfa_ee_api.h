...
enum
{
    ...
    NFA_EE_LMRT_STATUS_EVT,     /* The status for NFA_EeGetLmrtStatus ()                */
};
...
typedef union
{
    ...
    tNFA_EE_LMRT_STATUS     ee_lmrt_status;
} tNFA_EE_CBACK_DATA;
...
**
*******************************************************************************/
NFC_API extern tNFA_STATUS NFA_EeGetLmrtStatus (void);
...
**
*******************************************************************************/
NFC_API extern tNFA_STATUS NFA_EeDisconnectForce(tNFA_HANDLE ee_handle, UINT8 conn_id);
