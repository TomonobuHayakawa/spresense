...
#define NFA_DM_CORE_GEN_ERROR_REVT      8   /* CXD224x workaround: NCI CORE_GENERIC_ERROR_NTF */
#define NFA_DM_CORE_RESET_NTF_REVT      9   /* CXD224x workaround: NCI CORE_RESET_NTF */
#define NFA_DM_NOTIFY_NV_WRITE_EVT      10  /* CXD224x workaround: notify hci_nv_write */
#define NFA_DM_NOTIFY_ACT_FAIL_EVT      11  /* CXD224x workaround: notify hci_act_fail */
...
/* NFA Connection Callback Events(Proprietary) */
/* DTA workaronud */
#define NFA_POLL_CPLT_EVT                       80  /* POLL command completed                       */
...
/* NFA HALCC Callback */
typedef void (tNFA_HALCC_CBACK)(UINT8 event, UINT16 param_len, UINT8 *p_param);
...
**
*******************************************************************************/
NFC_API extern void NFA_Destroy (void);
