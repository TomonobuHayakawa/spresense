...
const tNFA_DM_ACTION nfa_dm_action[] =
{
    ...
    nfa_dm_act_send_halcc,              /* NFA_DM_API_HALCC_EVT              */
#endif
...
#include <assert.h>
    nfa_dm_cb_ptr = (tNFA_DM_CB *)GKI_os_malloc( sizeof(tNFA_DM_CB) );
    assert (nfa_dm_cb_ptr);
#endif
...
/*******************************************************************************
**
** Function         nfa_dm_destroy
**
** Description      Destroy the NFC device manager
**
** Returns          void
**
*******************************************************************************/
...
static char *nfa_dm_evt_2_str (UINT16 event)
{
    ...
    case NFA_DM_API_HALCC_EVT: /* add HalCtrlCmd */
        return "NFA_DM_API_HALCC_EVT";
