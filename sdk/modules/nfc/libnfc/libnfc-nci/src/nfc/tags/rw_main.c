...
#include <assert.h>
    rw_cb_ptr = (tRW_CB *)GKI_os_malloc( sizeof(tRW_CB) );
    assert (rw_cb_ptr);
#endif
...
tNFC_STATUS RW_SetActivatedTagType (tNFC_ACTIVATE_DEVT *p_activate_params, tRW_CBACK *p_cback)
{
    ...
    if (NFC_PROTOCOL_T1T == p_activate_params->protocol)
    {
        ...
        {
            rw_cb.tcb_type = RW_CB_TYPE_T1T;    /* LIBNCI bugfix: FIX_MEMORY_LEAK_0001 */
    ...
    else if (NFC_PROTOCOL_T2T == p_activate_params->protocol)
    {
        ...
        if (p_activate_params->rf_tech_param.mode == NFC_DISCOVERY_TYPE_POLL_A)
        {
            rw_cb.tcb_type = RW_CB_TYPE_T2T;    /* LIBNCI bugfix: FIX_MEMORY_LEAK_0001 */
    ...
    else if (NFC_PROTOCOL_T3T == p_activate_params->protocol)
    {
        ...
        {
            rw_cb.tcb_type = RW_CB_TYPE_T3T;    /* LIBNCI bugfix: FIX_MEMORY_LEAK_0001 */
    ...
    else if (NFC_PROTOCOL_ISO_DEP == p_activate_params->protocol)
    {
        ...
        {
            rw_cb.tcb_type = RW_CB_TYPE_T4T;    /* LIBNCI bugfix: FIX_MEMORY_LEAK_0001 */
    ...
    else if (NFC_PROTOCOL_15693 == p_activate_params->protocol)
    {
        ...
        {
            rw_cb.tcb_type = RW_CB_TYPE_I93;    /* LIBNCI bugfix: FIX_MEMORY_LEAK_0001 */
    ...
    {
        rw_cb.tcb_type = RW_CB_TYPE_NONE;    /* LIBNCI bugfix: FIX_MEMORY_LEAK_0001 */
