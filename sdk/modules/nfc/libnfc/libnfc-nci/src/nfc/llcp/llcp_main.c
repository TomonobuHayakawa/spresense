...
#if LLCP_DYNAMIC_MEMORY == TRUE
#include <assert.h>
    llcp_cb_ptr = (tLLCP_CB *)GKI_os_malloc( sizeof(tLLCP_CB) );
    assert (llcp_cb_ptr);
#endif
...
/*******************************************************************************
**
** Function         llcp_destroy
**
** Description      This function is called once at startup to destroy
**                  all the LLCP structures
**
** Returns          void
**
*******************************************************************************/
void llcp_destroy (void)
{
#if LLCP_DYNAMIC_MEMORY == TRUE
    if (llcp_cb_ptr)
        GKI_os_free (llcp_cb_ptr);
    llcp_cb_ptr = NULL;
#endif
}
