...
/* CXD224x workaround: MBL sz limitation ( refs #572 ) */
#define T4T_MAX_LENGTH_LC               (0xFF-7)    /* Max number of bytes written to NDEF file in UpdateBinary Command */
...
#define I93_CXD_MAX_READ_BLOCK_SIZE             144     /* CXD224x workaround: block read limitation max size = 157byte */
