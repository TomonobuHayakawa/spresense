...
#define NFC_PMID_LF_ADV_FEAT        NCI_PARAM_ID_LF_ADV_FEAT            /* add NCI 1.0 */
...
enum /* extra response event */
{
    NFC_CORE_RESET_NTF_REVT = NFC_FIRST_VS_REVT, /* 18 CORE_RESET notification */
};
...
/* The events reported on tNFC_HALCC_CBACK */
/* The event is id */
typedef UINT8 tNFC_HALCC_EVT;
/*************************************
**  HAL Control Command  Callback Functions
**************************************/
typedef void (tNFC_HALCC_CBACK) (tNFC_HALCC_EVT event, UINT16 data_len, UINT8 *p_data);
...
/*******************************************************************************
**
** Function         NFC_ConnDummyCreate
**
** Description      This function create Dummy Connection information
**
** Parameters       conn_id - the connection id.
**
** Returns          tNFC_STATUS
**
*******************************************************************************/
NFC_API extern tNFC_STATUS NFC_ConnDummyCreate (UINT8 conn_id);
...
** Function         NFC_Reset
**
** Description      This function send CORE_RESET_CMD to NFCC and enable
**                  NFC_FL_API_RESET flag
**
**                  When the CORE_RESET_RSP was received NFC_CORE_RESET_RSP_REVT
**                  is send to DM using the p_resp_cback
**
** Returns          tNFC_STATUS
**
*******************************************************************************/
NFC_API extern tNFC_STATUS NFC_Reset ();

/* CXD224x workaround: Add HalControlCommand                  */
/* import from nfc_hal_int_extra.h                            */
...
**
*******************************************************************************/
NFC_API extern tNFC_STATUS NFC_SendHalControlCommand (UINT8          id,
                                                      BT_HDR        *p_data,
                                                      tNFC_HALCC_CBACK *p_cback);
/*******************************************************************************
**
** Function         NFC_Destroy
**
** Description      This function destroy allocated memory of control block for NFC
**
** Returns          nothing
**
*******************************************************************************/
NFC_API extern void NFC_Destroy (void);
