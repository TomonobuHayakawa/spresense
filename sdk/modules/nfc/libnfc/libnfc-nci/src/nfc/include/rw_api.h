...
/*****************************************************************************
**
** Function         RW_T2tIsActiveState
**
** Description
**      Check if the t2t->state is active
**      This function is for NFC_CXD_WORKAROUND_T2TNACK_IDLE
**
** Returns
**      FALSE: if state is RW_T2T_STATE_NOT_ACTIVATED or RW_T2T_STATE_IDLE
**      TRUE: other cases
**
*****************************************************************************/
BOOLEAN RW_T2tIsActiveState(void);
