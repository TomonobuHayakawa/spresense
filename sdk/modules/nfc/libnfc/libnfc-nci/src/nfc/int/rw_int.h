...
#define RW_CB_TYPE_NONE    0   /* do not change this value */
#define RW_CB_TYPE_T1T     1
#define RW_CB_TYPE_T2T     2
#define RW_CB_TYPE_T3T     3
#define RW_CB_TYPE_T4T     4
#define RW_CB_TYPE_I93     5
typedef UINT8 tRW_CB_TYPE;
/* LIBNCI bugfix: FIX_MEMORY_LEAK_0001 end */

/* RW control blocks */
typedef struct
{
    tRW_CB_TYPE         tcb_type;   /* LIBNCI bugfix: FIX_MEMORY_LEAK_0001 */
    tRW_TCB             tcb;
    tRW_CBACK           *p_cback;
...
extern void rw_destroy (void); /*add for NFC_DYNAMIC_MEMORY == TRUE */
