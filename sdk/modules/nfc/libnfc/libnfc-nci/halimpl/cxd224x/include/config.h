...
#define NAME_UART_FC                    "UART_FC"   /* Flow Control */
...
#define NAME_DEVICE_RESET_DELAY         "DEVICE_RESET_DELAY"
...
#define NAME_NFA_DM_START_UP_RMW_CFG    "NFA_DM_START_UP_RMW_CFG"

/* add for CXD224x */
#define NAME_HAL_INIT_CTRL               "HAL_INIT_CTRL"
#define NAME_LMR_CFG                     "LMR_CFG"
#define NAME_NFA_DM_CLOSING_VSC_CFG      "NFA_DM_CLOSING_VSC_CFG"
#define NAME_HAL_LP_IDLE_TIMEOUT         "HAL_LP_IDLE_TIMEOUT"
#define NAME_HAL_LP_IDLE_LONG_TIMEOUT    "HAL_LP_IDLE_LONG_TIMEOUT"
...
void    readOptionalDebugConfig(const char* option);
...
/*******************************************************************************
 * Default configuration for CXD224x
 *
 *
 *******************************************************************************/
/* Enable Vender specific configuration before HAL close */
#ifndef NFC_HAL_CLOSE_CONFIG
#define NFC_HAL_CLOSE_CONFIG TRUE
#endif

/* LP UPIO_Set READ timeing *
 * change call order of UPIO_Set in case of read
 * if TRUE  (1)set UPIO_Set to high (2) do delay,
 * if FALSE UPIO_Set is low (3) do read
 */
#ifndef NFC_HAL_UPIO_SET_READ
#define NFC_HAL_UPIO_SET_READ TRUE
#endif
